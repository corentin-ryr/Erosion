...
public class perlinNoise : MonoBehaviour {
	...
	public static NoiseMethod[] valueMethod = {
		Perlin1D,
		Perlin2D,
		Perlin3D
	};
	...
	public static float Perlin1D (Vector3 point, float frequency) {
		...
		float g0 = gradient1D[hash[i0] & gradientMask1D];
		float g1 = gradient1D[hash[i1] & gradientMask1D];
	...
	private static float[] gradient1D = {
		-1f, 1f
	};
	...
	private static Vector2[] gradients3D = {
